...
public class DisplayCaseBER implements BlockEntityRenderer<DisplayCaseBlockEntity, SingleItemContainerRenderState> {
    ...
    @Override
    public void extractRenderState(DisplayCaseBlockEntity blockEntity, SingleItemContainerRenderState state, float partialTick, Vec3 p_445788_, ModelFeatureRenderer.@Nullable CrumblingOverlay p_446944_) {
