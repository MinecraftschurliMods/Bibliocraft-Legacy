...
public class BCEnglishLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(Translations.FANCY_TEXT_AREA_ALIGNMENT, "Toggle Alignment");
        add(Translations.FANCY_TEXT_AREA_BOLD, "Bold");
        add(Translations.FANCY_TEXT_AREA_BOLD_SHORT, "B");
        add(Translations.FANCY_TEXT_AREA_COLOR_HINT, "#RRGGBB");
        add(Translations.FANCY_TEXT_AREA_ITALIC, "Italic");
        add(Translations.FANCY_TEXT_AREA_ITALIC_SHORT, "I");
        add(Translations.FANCY_TEXT_AREA_MODE, "Toggle Shadow/Glowing");
        add(Translations.FANCY_TEXT_AREA_OBFUSCATED, "Obfuscated");
        add(Translations.FANCY_TEXT_AREA_OBFUSCATED_SHORT, "O");
        add(Translations.FANCY_TEXT_AREA_SCALE_DOWN, "-");
        add(Translations.FANCY_TEXT_AREA_SCALE_DOWN_TOOLTIP, "Scale Down");
        add(Translations.FANCY_TEXT_AREA_SCALE_UP, "+");
        add(Translations.FANCY_TEXT_AREA_SCALE_UP_TOOLTIP, "Scale Up");
        add(Translations.FANCY_TEXT_AREA_STRIKETHROUGH, "Strikethrough");
        add(Translations.FANCY_TEXT_AREA_STRIKETHROUGH_SHORT, "S");
        add(Translations.FANCY_TEXT_AREA_UNDERLINED, "Underlined");
        add(Translations.FANCY_TEXT_AREA_UNDERLINED_SHORT, "U");
