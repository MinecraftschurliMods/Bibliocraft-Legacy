...
public interface Translations {
    ...
    String STOCKROOM_CATALOG_ADD       = "item." + BibliocraftApi.MOD_ID + ".stockroom_catalog.add";
    String STOCKROOM_CATALOG_REMOVE    = "item." + BibliocraftApi.MOD_ID + ".stockroom_catalog.remove";
}
