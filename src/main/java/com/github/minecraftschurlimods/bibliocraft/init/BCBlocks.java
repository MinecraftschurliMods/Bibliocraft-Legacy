...
public interface BCBlocks {
    ...
    DeferredBlock<FancyLampBlock>          CLEAR_FANCY_GOLD_LAMP = BCRegistries.BLOCKS.register("fancy_gold_lamp", () -> new FancyLampBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    ColoredDeferredHolder<Block, FancyLampBlock> FANCY_GOLD_LAMP = coloredBlock(                "fancy_gold_lamp", () -> new FancyLampBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    DeferredBlock<FancyLampBlock>          CLEAR_FANCY_IRON_LAMP = BCRegistries.BLOCKS.register("fancy_iron_lamp", () -> new FancyLampBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    ColoredDeferredHolder<Block, FancyLampBlock> FANCY_IRON_LAMP = coloredBlock(                "fancy_iron_lamp", () -> new FancyLampBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    DeferredBlock<FancyLanternBlock>          CLEAR_FANCY_GOLD_LANTERN = BCRegistries.BLOCKS.register("fancy_gold_lantern",        () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    ColoredDeferredHolder<Block, FancyLanternBlock> FANCY_GOLD_LANTERN = coloredBlock(                "fancy_gold_lantern",        () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    DeferredBlock<FancyLanternBlock>           SOUL_FANCY_GOLD_LANTERN = BCRegistries.BLOCKS.register("soul_fancy_gold_lantern",   () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 10 : 0).noOcclusion(), BCUtil.modLoc("buzzier_bees", "small_soul_fire_flame")));
    DeferredBlock<FancyLanternBlock>          CLEAR_FANCY_IRON_LANTERN = BCRegistries.BLOCKS.register("fancy_iron_lantern",        () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    ColoredDeferredHolder<Block, FancyLanternBlock> FANCY_IRON_LANTERN = coloredBlock(                "fancy_iron_lantern",        () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 15 : 0).noOcclusion()));
    DeferredBlock<FancyLanternBlock>           SOUL_FANCY_IRON_LANTERN = BCRegistries.BLOCKS.register("soul_fancy_iron_lantern",   () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).sound(SoundType.LANTERN).lightLevel(state -> state.getValue(AbstractFancyLightBlock.LIT) ? 10 : 0).noOcclusion(), BCUtil.modLoc("buzzier_bees", "small_soul_fire_flame")));
