...
import at.minecraftschurli.mods.bibliocraft.content.fancysign.AbstractFancySignBlock;
...
import at.minecraftschurli.mods.bibliocraft.content.fancysign.FancySignContent;
...
public class FancySignBER implements BlockEntityRenderer<FancySignBlockEntity, FancySignBER.State> {
    ...
    @Override
    public void extractRenderState(FancySignBlockEntity blockEntity, State state, float partialTick, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
