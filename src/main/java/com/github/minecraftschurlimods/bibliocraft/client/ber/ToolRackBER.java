...
public class ToolRackBER implements BlockEntityRenderer<ToolRackBlockEntity, MultiItemContainerRenderState> {
    ...
    @Override
    public void extractRenderState(ToolRackBlockEntity blockEntity, MultiItemContainerRenderState state, float partialTick, Vec3 p_445788_, ModelFeatureRenderer.@Nullable CrumblingOverlay p_446944_) {
