...
/// @param woodType   The corresponding vanilla [WoodType].
/// @param properties A supplier for the wood type's [BlockBehaviour.Properties].
/// @param texture    The location of the wood type's plank texture. Used in datagen.
/// @param family     A supplier for the corresponding [BlockFamily]. Used in datagen.
public record BibliocraftWoodType(Identifier id, WoodType woodType, Supplier<BlockBehaviour.Properties> properties, Identifier texture, Supplier<BlockFamily> family) {
