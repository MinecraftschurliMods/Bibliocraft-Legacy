...
public class LabelBER implements BlockEntityRenderer<LabelBlockEntity, MultiItemContainerRenderState> {
    ...
    @Override
    public void extractRenderState(LabelBlockEntity blockEntity, MultiItemContainerRenderState state, float partialTick, Vec3 p_445788_, ModelFeatureRenderer.@Nullable CrumblingOverlay p_446944_) {
