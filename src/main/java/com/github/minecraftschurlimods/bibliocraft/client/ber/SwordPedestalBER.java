...
public class SwordPedestalBER implements BlockEntityRenderer<SwordPedestalBlockEntity, SingleItemContainerRenderState> {
    ...
    @Override
    public void extractRenderState(SwordPedestalBlockEntity blockEntity, SingleItemContainerRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
