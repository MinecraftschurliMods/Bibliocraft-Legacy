package at.minecraftschurli.mods.bibliocraft.util.lectern;
...
public final class LecternUtil {
    ...
    /// @param state   The [BlockState] of the lectern.
    /// @param lectern The [LecternBlockEntity] of the lectern.
    /// @param player  The [Player] using the lectern.
    /// @param hand    The [InteractionHand] context.
    ...
    /// Removes the book from the lectern at the given location and adds it to the [Player]'s inventory.
    ///
    /// @param player The [Player] to add the lectern's book to.
    /// @param level  The [Level] of the lectern.
    /// @param pos    The [BlockPos] of the lectern.
    ...
    /// Runs the given [Consumer] if a [LecternBlockEntity] is found at the given location.
    ///
    /// @param level    The [Level] of the lectern.
    /// @param pos      The [BlockPos] of the lectern.
    ...
    /// Runs the given [Function] and returns its result if a [LecternBlockEntity] is found at the given location.
    ///
    /// @param level    The [Level] of the lectern.
    /// @param pos      The [BlockPos] of the lectern.
    ...
    /// Opens a screen for the given [ItemStack] on the client. The [ItemStack] is assumed to be inside a lectern.
    ///
