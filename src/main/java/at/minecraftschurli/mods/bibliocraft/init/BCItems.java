...
import at.minecraftschurli.mods.bibliocraft.content.bigbook.BigBookItem;
...
import at.minecraftschurli.mods.bibliocraft.content.clipboard.ClipboardItem;
import at.minecraftschurli.mods.bibliocraft.content.clock.FancyClockItem;
import at.minecraftschurli.mods.bibliocraft.content.discrack.DiscRackItem;
import at.minecraftschurli.mods.bibliocraft.content.displaycase.DisplayCaseItem;
import at.minecraftschurli.mods.bibliocraft.content.fancysign.FancySignItem;
import at.minecraftschurli.mods.bibliocraft.content.lockandkey.LockAndKeyItem;
import at.minecraftschurli.mods.bibliocraft.content.plumbline.PlumbLineItem;
import at.minecraftschurli.mods.bibliocraft.content.redstonebook.RedstoneBookItem;
import at.minecraftschurli.mods.bibliocraft.content.seat.SeatBackItem;
import at.minecraftschurli.mods.bibliocraft.content.seat.SeatBackType;
import at.minecraftschurli.mods.bibliocraft.content.slottedbook.SlottedBookItem;
import at.minecraftschurli.mods.bibliocraft.content.stockroomcatalog.StockroomCatalogItem;
import at.minecraftschurli.mods.bibliocraft.content.swordpedestal.SwordPedestalBlock;
import at.minecraftschurli.mods.bibliocraft.content.tapemeasure.TapeMeasureItem;
import at.minecraftschurli.mods.bibliocraft.content.typewriter.TypewriterPage;
import at.minecraftschurli.mods.bibliocraft.content.typewriter.TypewriterPageItem;
import at.minecraftschurli.mods.bibliocraft.util.block.ColoredWoodTypeBlockItem;
import at.minecraftschurli.mods.bibliocraft.util.holder.CopperSet;
...
public interface BCItems {
    ...
    GroupedHolder.Nested<BibliocraftWoodType, DyeColor, Item, BlockItem>    SEAT              = coloredWoodItem("seat",             (wood, color, p) -> new ColoredWoodTypeBlockItem(BCBlocks.SEAT, wood, color, p.useBlockDescriptionPrefix()));
    GroupedHolder.Nested<BibliocraftWoodType, DyeColor, Item, SeatBackItem> SMALL_SEAT_BACK   = coloredWoodItem("small_seat_back",  (wood, color, p) -> new SeatBackItem(BCBlocks.SEAT_BACK, wood, color, SeatBackType.SMALL, p.useItemDescriptionPrefix()));
    GroupedHolder.Nested<BibliocraftWoodType, DyeColor, Item, SeatBackItem> RAISED_SEAT_BACK  = coloredWoodItem("raised_seat_back", (wood, color, p) -> new SeatBackItem(BCBlocks.SEAT_BACK, wood, color, SeatBackType.RAISED, p.useItemDescriptionPrefix()));
    GroupedHolder.Nested<BibliocraftWoodType, DyeColor, Item, SeatBackItem> FLAT_SEAT_BACK    = coloredWoodItem("flat_seat_back",   (wood, color, p) -> new SeatBackItem(BCBlocks.SEAT_BACK, wood, color, SeatBackType.FLAT, p.useItemDescriptionPrefix()));
    GroupedHolder.Nested<BibliocraftWoodType, DyeColor, Item, SeatBackItem> TALL_SEAT_BACK    = coloredWoodItem("tall_seat_back",   (wood, color, p) -> new SeatBackItem(BCBlocks.SEAT_BACK, wood, color, SeatBackType.TALL, p.useItemDescriptionPrefix()));
    GroupedHolder.Nested<BibliocraftWoodType, DyeColor, Item, SeatBackItem> FANCY_SEAT_BACK   = coloredWoodItem("fancy_seat_back",  (wood, color, p) -> new SeatBackItem(BCBlocks.SEAT_BACK, wood, color, SeatBackType.FANCY, p.useItemDescriptionPrefix()));
    ...
    DeferredItem<BigBookItem>          BIG_BOOK               = registerItem("big_book", BigBookItem::new, p -> p.stacksTo(1).component(DataComponents.MAX_STACK_SIZE, 1).component(BCDataComponents.BIG_BOOK_CONTENT, BigBookContent.DEFAULT));
    DeferredItem<BigBookItem>          WRITTEN_BIG_BOOK       = registerItem("written_big_book", BigBookItem::new, p -> p.stacksTo(1).component(DataComponents.MAX_STACK_SIZE, 1).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true).component(BCDataComponents.WRITTEN_BIG_BOOK_CONTENT, WrittenBigBookContent.DEFAULT));
    ...
    DeferredItem<RedstoneBookItem>     REDSTONE_BOOK          = registerItem("redstone_book", RedstoneBookItem::new, p -> p.stacksTo(1));
    DeferredItem<SlottedBookItem>      SLOTTED_BOOK           = registerItem("slotted_book", SlottedBookItem::new, p -> p.stacksTo(1));
    DeferredItem<StockroomCatalogItem> STOCKROOM_CATALOG      = registerItem("stockroom_catalog", StockroomCatalogItem::new, p -> p.stacksTo(1));
