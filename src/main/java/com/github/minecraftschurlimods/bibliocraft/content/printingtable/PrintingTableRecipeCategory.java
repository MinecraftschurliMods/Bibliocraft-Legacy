...
public class PrintingTableRecipeCategory extends AbstractRecipeCategory<RecipeHolder<PrintingTableRecipe>> {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<PrintingTableRecipe> recipeHolder, IFocusGroup focuses) {
        PrintingTableRecipe recipe = recipeHolder.value();
