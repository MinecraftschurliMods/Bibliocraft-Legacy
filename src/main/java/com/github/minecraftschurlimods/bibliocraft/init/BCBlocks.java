...
public interface BCBlocks {
    ...
    DeferredBlock<FancyLanternBlock>          ENDER_FANCY_GOLD_LANTERN = BCRegistries.BLOCKS.register("ender_fancy_gold_lantern",  () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK).sound(SoundType.LANTERN).lightLevel($ -> 15).noOcclusion(), BCUtil.modLoc("endergetic",         "small_ender_fire_flame")));
    DeferredBlock<FancyLanternBlock>         CUPRIC_FANCY_GOLD_LANTERN = BCRegistries.BLOCKS.register("cupric_fancy_gold_lantern", () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK).sound(SoundType.LANTERN).lightLevel($ -> 10).noOcclusion(), BCUtil.modLoc("caverns_and_chasms", "small_cupric_fire_flame")));
    ...
    DeferredBlock<FancyLanternBlock>          ENDER_FANCY_IRON_LANTERN = BCRegistries.BLOCKS.register("ender_fancy_iron_lantern",  () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).sound(SoundType.LANTERN).lightLevel($ -> 15).noOcclusion(), BCUtil.modLoc("endergetic",         "small_ender_fire_flame")));
    DeferredBlock<FancyLanternBlock>         CUPRIC_FANCY_IRON_LANTERN = BCRegistries.BLOCKS.register("cupric_fancy_iron_lantern", () -> new FancyLanternBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).sound(SoundType.LANTERN).lightLevel($ -> 10).noOcclusion(), BCUtil.modLoc("caverns_and_chasms", "small_cupric_fire_flame")));
