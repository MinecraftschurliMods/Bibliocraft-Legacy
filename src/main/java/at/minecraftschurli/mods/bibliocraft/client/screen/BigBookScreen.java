...
import at.minecraftschurli.mods.bibliocraft.client.widget.ColorButton;
import at.minecraftschurli.mods.bibliocraft.client.widget.FormattedTextArea;
...
public class BigBookScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (isSigning) {
            ...
            graphics.textWithWordWrap(font, Translations.VANILLA_FINALIZE_WARNING, x + 18, 82, TEXT_WIDTH, 0xff000000, false);
        } else {
