...
public class PotionShelfBER implements BlockEntityRenderer<PotionShelfBlockEntity, MultiItemContainerRenderState> {
    ...
    @Override
    public void extractRenderState(PotionShelfBlockEntity blockEntity, MultiItemContainerRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
