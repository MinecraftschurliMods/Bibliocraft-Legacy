...
public interface BCRecipes {
    ...
    Supplier<RecipeSerializer<PrintingTableMergingRecipe>>  PRINTING_TABLE_MERGING  = BCRegistries.RECIPE_SERIALIZERS.register("printing_table_merging",  serializer(PrintingTableMergingRecipe.CODEC, PrintingTableMergingRecipe.STREAM_CODEC));
